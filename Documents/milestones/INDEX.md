...
- **T1** — Loadable Windows build (Config/Tilemaps packaging OK on `059e3dd`; re-cut after host loopback fix)
...
- **M8** — Armor seal + internals + air alarms that alarm + thin fire response (turf→health exposure shipped)
