...
> Current focus: T1 (loadable Windows build — missing content/permissions), T2 (zero-setup remote join)
...
- **Hosted dedicated server** — foundations shipped ([2026-07_headless-dedicated-server.md](../architecture/2026-07_headless-dedicated-server.md), [2026-07_session-world-lifecycle.md](../architecture/2026-07_session-world-lifecycle.md)); still **partial** — drop/selection interaction against a real remote client is a known unfixed break ([networking-session](../architecture/systems/networking-session.md)), which matters the moment strangers connect for real.
- **Round-end loop + latejoin** — the same round-resolution spine MVP1 needs ([round-end.md](../design/round-end.md) §5–§6): round ends → summary → return-to-lobby transition, plus latejoin so players join a round already running ([lobby.md](../design/lobby.md) §7). Shared with [mvp1-nuke-ops.md](mvp1-nuke-ops.md) M5; a minimal sandbox loop is enough to start hosting before MVP1 gameplay is done.
...
| T3 | Hosted dedicated server reachable | partial — server ships; remote-client drop/selection break open | [2026-07_headless-dedicated-server.md](../architecture/2026-07_headless-dedicated-server.md); [2026-07_session-world-lifecycle.md](../architecture/2026-07_session-world-lifecycle.md) |
| T4 | Round-end loop + latejoin | pending — shared with MVP1 M5 | [round-end.md](../design/round-end.md) §5–§6; [lobby.md](../design/lobby.md) §7; [mvp1-nuke-ops.md](mvp1-nuke-ops.md) M5 |
