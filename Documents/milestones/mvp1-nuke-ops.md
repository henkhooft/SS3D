...
- **Combat feel (M1p)** — **partial:** muzzle flash, bullet-hole shreds, SS14 gun+surface audio, fire/reload Upper Body anims, two-hand M4, `rangeddebug` spheres off by default, reticle hit-flash centered ([combat](../architecture/systems/combat.md)). **Still open:** blood polish, aim IK (deferred), knockdown/stagger recovery clarity, sprint under encumbrance, strip hit-debug **and** other debug chrome (F2 screen-effects, atmos P-overlay, etc.) from normal play ([audio](../architecture/systems/audio.md); [screen-effects](../architecture/systems/screen-effects.md)).
...
- **Env→health remainder (M8)** — turf exposure shipped ([health-env-feel](../architecture/2026-07_health-env-feel.md)); equal-pressure composition diffusion on turf shipped (breath pockets mix into the room — [atmospherics](../architecture/systems/atmospherics.md)); still need environmental armor seal ([armor.md](../design/armor.md) §3), air alarms that **actually alarm**, extinguisher / thin fire counter; internals ride M0 loadouts ([health](../architecture/systems/health.md)).
...
| M1p | Combat feel polish (VFX, decals, blood, sounds, aim IK, two-hand, reload cues, knockdown clarity, sprint, no debug chrome) | partial — **focus** (muzzle/holes/SS14 audio/anims/two-hand/`rangeddebug`/reticle flash shipped; blood, knockdown, sprint, strip debug chrome open; aim IK deferred) | [combat](../architecture/systems/combat.md); [audio](../architecture/systems/audio.md); [entities](../architecture/systems/entities.md); [stamina](../architecture/systems/stamina.md) |
...
| M8 | Env→health + armor seal + internals + air alarms that alarm + thin fire response | partial — turf exposure shipped ([health-env-feel](../architecture/2026-07_health-env-feel.md)); equal-P turf diffusion shipped; seal/internals/alarms/fire response open | [armor.md](../design/armor.md) §3; [health](../architecture/systems/health.md); [atmospherics](../architecture/systems/atmospherics.md); [area.md](../design/area.md) §5 |
| M9 | Test-map power/lights matter + wall damage readable at range | pending — **focus** | [electricity](../architecture/systems/electricity.md); [area](../architecture/systems/area.md); [structural-destruction](../architecture/systems/structural-destruction.md) || M6 | MVP1 playable close | pending | depends M0–M5, M1p, M7–M9 |
