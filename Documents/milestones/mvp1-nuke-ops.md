...
| M5 | Round resolution spine: death→spectator + round-end summary/reveal | pending — **focus** (newly surfaced); death detach already wired, summary/reveal net-new | [observer.md](../design/observer.md) §2, §7; [round-end.md](../design/round-end.md) §4–§6; [entities](../architecture/systems/entities.md) (ghost); [gamemodes-roles-traits](../architecture/systems/gamemodes-roles-traits.md) (`EndRound`) |
