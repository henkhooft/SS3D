...
| audio | [audio.md](../design/audio.md) — active | [audio-foundation](2026-07_audio-foundation.md) — in-progress (Phase 1 SFX occlusion + Phase 2 per-area ambience shipped; Phase 0/3-5 pending) | [audio](systems/audio.md) — partial (split from chat-audio-screens) |
...
| Audio | [audio](systems/audio.md) | partial | Networked SFX/music pool (`AudioSubSystem`); client-local occlusion (`AudioSourceOcclusion`, seventh `LineOfSight` consumer); per-area ambience crossfade (`AmbienceSubSystem`, self-bootstrapped) off synced `AreaRecord.AmbienceTrackId`; Boombox/NoisyCollision; legacy `AmbienceHandler` superseded |
...
| [2026-07_audio-foundation](2026-07_audio-foundation.md) | in-progress (Phase 1 client-local SFX occlusion + Phase 2 per-area ambience shipped; Phase 0 mixer groups, Phase 3 personal heartbeat/breathing, Phase 4 alerts, Phase 5 music/settings pending) |
