...
| Furniture / world objects | [furniture](systems/furniture.md) | partial | Airlocks (HashGrid proximity + NetworkAnimator observer gate + Open/Close + access-denied), lockers, vendors, jukebox; disposal → [disposal](systems/disposal.md); vending via diegetic machine-interface |
