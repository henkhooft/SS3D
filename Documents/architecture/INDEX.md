...
| atmospherics | [atmospherics.md](../design/atmospherics.md) — active | [atmos-ecs-foundation](2026-07_atmos-ecs-foundation.md) — shipped (partial; equal-P composition diffusion follow-on); [atmos-client-visualization-sync](2026-07_atmos-client-visualization-sync.md) — shipped (Phase 1 dirty-chunk; Phase 2 late-join/AOI open) | [atmospherics](systems/atmospherics.md) — partial |
