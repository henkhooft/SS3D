...
| [2026-07_session-world-lifecycle](2026-07_session-world-lifecycle.md) | planned (Phase 1 session FSM standalone; Phase 2 world readiness graph; Phase 3 code bootstrap + `NetworkSystemsHub` — realizes agent-first-composition (a)) |
