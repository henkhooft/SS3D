...
| Chat / screens | [chat-audio-screens](systems/chat-audio-screens.md) | partial | Local speech chips + T-compose (occlusion via shared `LineOfSight`); always-on chat UI Phase 0 purged (headless ChatSubSystem); camera; camera ownership planned ([camera-ownership](2026-07_camera-ownership.md)) |
