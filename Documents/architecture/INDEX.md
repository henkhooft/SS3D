...
| Combat | [combat](systems/combat.md) | partial | Phase 0–1 melee + Phase 3 ranged hitscan (M4, accuracy cone, shared LOS, mag/reload) + Phase 4 stamina drains/exertion feedback (swing+fire; block deferred); disarm/armor/blocking/projectile deferred |
