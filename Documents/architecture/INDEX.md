...
| examine | [examine.md](../design/examine.md) — active | none yet | [examine](systems/examine.md) — partial (character-examine §7 + health Tier 0/1 + interruptible hold-to-take on UITK; obscured-slot filter + restrained loot + StoragePanel foreign-loot still open) |
...
| chemistry | [chemistry.md](../design/chemistry.md) — active | [substances-foundation](2026-07_substances-foundation.md) — planned (Phases 0–2 primitives; gameplay / MVP2 deferred) | [substances](systems/substances.md) — partial |
...
| Examine | [examine](systems/examine.md) | partial | Hover/detailed examine on UITK; character paperdoll + take; health Tier 0/1 lines + Shift→self fallback |
...
| Substances | [substances](systems/substances.md) | partial | Legacy containers/transfer still in tree; clean-slate foundation planned — [substances-foundation](2026-07_substances-foundation.md) |
...
| [2026-07_substances-foundation](2026-07_substances-foundation.md) | planned (Phases 0–2: shared reagent defs, networked containers, reaction+heat; chemistry gameplay MVP2) |
