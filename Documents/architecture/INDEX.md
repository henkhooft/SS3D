...
| examine | [examine.md](../design/examine.md) — active | none yet | [examine](systems/examine.md) — partial (character-examine §7 + interruptible hold-to-take on UITK; obscured-slot filter + restrained loot + StoragePanel foreign-loot still open) |
