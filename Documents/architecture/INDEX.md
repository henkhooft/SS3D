...
| audio | [audio.md](../design/audio.md) — active | [audio-foundation](2026-07_audio-foundation.md) — in-progress (Phase 1 SFX occlusion shipped; Phase 0/2-5 pending) | [audio](systems/audio.md) — partial (split from chat-audio-screens) |
...
| Audio | [audio](systems/audio.md) | partial | Networked SFX/music pool (`AudioSubSystem`); client-local occlusion (`AudioSourceOcclusion`, seventh `LineOfSight` consumer); Boombox/NoisyCollision; legacy `AmbienceHandler` unwired, superseded by [audio-foundation](2026-07_audio-foundation.md) Phase 2 |
...
| [2026-07_audio-foundation](2026-07_audio-foundation.md) | in-progress (Phase 1 client-local SFX occlusion shipped over legacy `AudioSubSystem` pool; Phase 0 mixer groups, Phase 2 per-area ambience, Phase 3 personal heartbeat/breathing, Phase 4 alerts, Phase 5 music/settings pending) |
