...
| Combat | [combat](systems/combat.md) | partial | Phase 0–1 melee + Phase 3 ranged hitscan (M4, accuracy cone, shared LOS, mag/reload) + Phase 5 per-zone armor absorption/integrity; disarm/projectile/environmental seal deferred |
