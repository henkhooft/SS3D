...
- `Assets/Scripts/SS3D/Interactions/InteractionPipeline.cs` — shared discover → filter → sort; `TryEvaluateOutlineInteractability` for hover LateUpdate; `FilterForOutline` for list-based outline filters
