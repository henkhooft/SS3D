...
> Status: partial
> Verified: c996212b2 — 2026-07-26 (item world rest orientation)
...
- `Assets/Scripts/SS3D/Systems/Inventory/Items/Item.cs` — `WorldRestRotation` / `GetWorldFacing` for floor spawn/drop/icons
