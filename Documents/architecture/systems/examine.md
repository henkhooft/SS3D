...
> Entry points: ExamineSubSystem, ExamineOverlaySubSystem, ExamineContentResolver, CharacterExamineHealthBuilder, TakeFromCharacterInteraction
> Status: partial
...
**Editor:** **SS3D → Examine → Rebuild Examine Asset Catalog**.
...
- **Hover paperdoll blocks Shift+Click:** paperdoll is Shift+Click-only; hover is name tooltip.
...
- **Depends on:** [selection](selection.md), [localization](localization.md), [inputs](inputs.md), [inventory](inventory.md), [health](health.md), [interactions-framework](interactions-framework.md), [ui-shell](ui-shell.md), [core-subsystems](core-subsystems.md)
...
- Tests: `ExamineContentResolverTests`, `CharacterExamineHealthBuilderTests`, `CharacterExamineContentBuilderTests`, `CharacterExamineSlotContainerMapTests`, `CharacterLootUtilityTests`
