...
- `Assets/Scripts/SS3D/Systems/Tile/TileSubSystem.cs` — subsystem entry point; owns `SpawnPoints` registry
...
- System map: [area](area.md); hooks: [map-editor-creative-hooks](map-editor-creative-hooks.md)
